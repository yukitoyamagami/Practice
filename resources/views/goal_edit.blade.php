...
<div class="container-fluid">
	<div class="row_top">
		<div class="col-xs-8 col-md-8 mx-auto">
			<h2 mx-auto style="text-align:left;">目標情報を編集しましょう</h2>
			<form action="{{ action('SoukatuController@update') }}" method="post" enctype="multipart/form-data">
			         @if (count($errors) > 0)
			    ...
			    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="text" size="10" class="form-control" name="title" value="{{ $goal_form->title }}">
                        </div>
                </div>
                <div class="form-group row">
                        <label class="col-md-2">目標計画</label>
                        <div class="col-md-10">
                            <textarea class="form-control" name="body" rows="10">{{ $goal_form->body }}</textarea>
                        </div>
                </div>
                <div class="form-group row">
                ...
                <input type="hidden" name="id" value="{{ $goal_form->id }}">
                {{ csrf_field() }}
                    <div><input type="submit" class="btn btn-primary mx-auto" value="目標情報更新！"></div>
                </form>
		</div>
	</div>
</div>
